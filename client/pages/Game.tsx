...
export default function Game() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white font-manrope overflow-x-hidden">
      <div className="relative min-h-screen flex flex-col px-4 py-6 sm:py-10">
        ...
        <div className="flex items-start justify-between mb-6 sm:mb-8">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 px-6 sm:px-10 py-3 sm:py-4 rounded-full border-2 border-[#FF6200] bg-[#0A0A0A] shadow-lg hover:bg-[#181818] transition"
          >
            ...
            <span className="text-[#FF6200] font-medium text-sm sm:text-lg">Home</span>
          </Link>
          ...
          <div className="hidden sm:flex absolute left-1/2 -translate-x-1/2 top-6 items-center gap-2">
            ...
            <div className="text-2xl sm:text-3xl font-instrument">
              ...
              <span className="italic text-white">asian</span>
            </div>
          </div>

          {/* Timer */}
          <div className="flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full border-4 border-[#FF6200]">
            <span className="text-[#FF6200] font-medium text-sm sm:text-lg">{String(timeRemaining).padStart(2, '0')}</span>
          </div>
        </div>

        {/* Progress Section */}
        <div className="w-full max-w-6xl mx-auto mb-8">
          <div className="text-[#FF6200] font-medium text-xl sm:text-3xl mb-3">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-6xl bg-[#181818] rounded-3xl shadow-2xl p-6 sm:p-12 md:p-16">
            {/* Face Image */}
            <div className="flex justify-center mb-8 sm:mb-12">
              <div className="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-3xl border border-[#FF6200] overflow-hidden shadow-lg">
                <img
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 max-w-3xl mx-auto">
              {options.map((option) => (
                <button
                  ...
                  className={`
                    py-6 sm:py-8 px-4 rounded-2xl border border-[#FF6200] bg-[#000]
                    text-white font-medium text-lg sm:text-2xl md:text-3xl
                    transition-all duration-200
                    hover:bg-[#FF6200] hover:text-white
                    disabled:opacity-50
                    ${selectedAnswer === option ? 'bg-[#FF6200] text-white' : ''}
                    shadow-[0_0_3.652px_rgba(0,0,0,0.5)]
                  `}
                >
                  {option}
                </button>
