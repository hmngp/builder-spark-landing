      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 py-16">
        ...
        <div className="w-full max-w-5xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="mt-3 text-lg sm:text-xl opacity-90">Tailor your challenge before you play.</p>
          </div>
          ...
          <form className="grid gap-8 sm:gap-10 md:grid-cols-2">
            ...
            <fieldset className="bg-[hsl(var(--card))] border-2 border-[hsl(var(--border))] rounded-xl p-6 shadow-[0_12px_24px_rgba(0,0,0,0.08)]">
              <legend className="px-2 font-instrument text-2xl text-primary">Mode</legend>
              <div className="mt-4 grid gap-3">
                {[
                  ...
                  <label key={o.id} className="flex items-center gap-3 cursor-pointer">
                    <input type="radio" name="mode" defaultChecked={o.id === "quick"} className="accent-[hsl(var(--primary))] w-4 h-4" />
            ...
            {/* Difficulty */}
            <fieldset className="bg-[hsl(var(--card))] border-2 border-[hsl(var(--border))] rounded-xl p-6 shadow-[0_12px_24px_rgba(0,0,0,0.08)]">
              <legend className="px-2 font-instrument text-2xl text-primary">Difficulty</legend>
              <div className="mt-4 grid gap-3">
                {[
                  { id: "easy", label: "Easy" },
                  ...
                  <label key={o.id} className="flex items-center gap-3 cursor-pointer">
                    <input type="radio" name="difficulty" defaultChecked={o.id === "medium"} className="accent-[hsl(var(--primary))] w-4 h-4" />
                    <span className="text-lg">{o.label}</span>
                  </label>
                ))}
              </div>
            ...
            <fieldset className="bg-[hsl(var(--card))] border-2 border-[hsl(var(--border))] rounded-xl p-6 shadow-[0_12px_24px_rgba(0,0,0,0.08)] md:col-span-2">
              <legend className="px-2 font-instrument text-2xl text-primary">Extras</legend>
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <label key={o.id} className="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" defaultChecked={o.id === "streaks"} className="accent-[hsl(var(--primary))] w-4 h-4" />
                    <span className="text-lg">{o.label}</span>
                  </label>
                ))}
              </div>
