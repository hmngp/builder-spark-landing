...
export const RetroButton = forwardRef<HTMLButtonElement, Props>(
  ({ className, variant = "primary", children, ...props }, ref) => {
    const base =
      "inline-flex items-center justify-center uppercase tracking-wide font-semibold rounded-full transition focus:outline-none focus:ring-2 focus:ring-[hsl(var(--ring))]";
